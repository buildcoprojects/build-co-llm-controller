...
export default function AdminPage() {
  ...
  const fetchSignals = async () => {
    setIsLoading(true);
    try {
      console.log('Fetching signals from /api/signals...');
      ...
      <div className="flex flex-col space-y-6">
        ...
        <div className="flex flex-col gap-4">
          <Card>
            ...
            <CardContent>
              <div className="p-2 bg-gray-100 mb-2 max-h-48 overflow-auto rounded">
                <pre className="text-xs text-gray-600">{JSON.stringify(signals, null, 2)}</pre>
              </div>
              {isLoading ? (
